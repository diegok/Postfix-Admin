...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{POSTADMIN_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{POSTADMIN_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
postadmin_server.pl - Catalyst Testserver

=head1 SYNOPSIS

postadmin_server.pl [options]
